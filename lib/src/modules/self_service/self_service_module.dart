...
import 'package:fe_lab_clinicas_self_service/src/modules/self_service/who_i_m/who_i_am_page.dart';
import 'package:fe_lab_clinicas_self_service/src/respositories/information_form/information_form_repositoy.dart';
import 'package:fe_lab_clinicas_self_service/src/respositories/information_form/information_form_repositoy_impl.dart';
import 'package:fe_lab_clinicas_self_service/src/respositories/patients/patients_repository.dart';
import 'package:fe_lab_clinicas_self_service/src/respositories/patients/patients_repository_impl.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  List<Bind<Object>> get bindings => [
        Bind.lazySingleton<InformationFormRepositoy>(
            (i) => InformationFormRepositoyImpl(restClient: i())),
        Bind.lazySingleton<SelfServiceController>(
            (i) => SelfServiceController(informationFormRepositoy: i())),
